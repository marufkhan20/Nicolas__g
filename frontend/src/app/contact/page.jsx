  ...
  return (
    <main>
      ...
      <section className="font-sans px-5 sm:px-0">
        <div className="container bg-white grid sm:grid-cols-2 lg:grid-cols-3 gap-10 px-16 py-20">
          <div>
      ...
      <section className="py-[180px] px-5 sm:px-0 sm:w-[70%] md:w-[50%] mx-auto font-sans">
